...
class MyStoreHomeScreen extends StatefulWidget {
  const MyStoreHomeScreen({Key? key}) : super(key: key);

  @override
  State<MyStoreHomeScreen> createState() => _MyStoreHomeScreenState();
}

class _MyStoreHomeScreenState extends State<MyStoreHomeScreen> {
  @override
  void initState() {
    _getUserOrders();
    _getProducts();
    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            const CustomHeader(text: 'My Store'),
